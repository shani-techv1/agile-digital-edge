...
const partners = [
  {
    ...
    desc: "Need robust backend and web development support for complex client campaigns and platforms.",
  },
  {
    icon: Code2,
    title: "Software Companies",
    desc: "Looking to extend their engineering teams to clear project backlogs and deliver faster.",
  },
  {
    icon: Briefcase,
    title: "IT Consulting Firms",
    desc: "Need reliable partners to implement enterprise CMS, CRM, and ERP solutions for their clients.",
  },
  {
    icon: Building,
    title: "Enterprises",
    desc: "Seeking custom platforms and AI integration without the overhead of hiring a massive internal IT department.",
  },
];
...
const features = [
  {
    ...
    desc: "All work is delivered entirely under your brand — your clients never know about Agile Digital Edge.",
  },
  {
    icon: Users,
    title: "Dedicated Teams",
    desc: "Developers work exclusively on your projects with full dedication and context.",
  },
  {
    icon: MessageSquare,
    title: "Transparent Process",
    desc: "Clear communication, agile workflows, and real-time project visibility at all times.",
  },
  {
    icon: TrendingUp,
    title: "Scalable Capacity",
    desc: "Instantly scale team size up or down based on your project pipeline and requirements.",
  },
];
...
const services = [
  {
    icon: FolderOpen,
    title: "White Label CMS Development",
    desc: "Enterprise CMS implementation, migration, customization, and performance optimization.",
    tags: ["Optimizely", "Sanity"],
  },
  {
    icon: Handshake,
    title: "White Label CRM Development",
    desc: "Advanced CRM solutions including Salesforce customization, CRM integrations, and custom builds.",
    tags: ["Salesforce", "Custom CRM", "Analytics"],
  },
  {
    icon: Code2,
    title: "White Label Custom Software",
    desc: "Scalable enterprise software, SaaS applications, workflow automation, and business platforms.",
    tags: ["SaaS", "Automation", "Portals"],
  },
  {
    icon: AppWindow,
    title: "Web Application Development",
    desc: "Modern web platforms using .NET Core, React, Next.js, Angular — fast, secure, and built to scale.",
    tags: [".NET Core", "ReactJS", "Next.js"],
  },
  {
    icon: Wand2,
    title: "White Label AI Solutions",
    desc: "Custom AI chatbots, AI-powered applications, intelligent automation tools, and AI agents.",
    tags: ["AI Chatbots", "AI Agents", "Automation"],
  },
  {
    icon: Layers,
    title: "Headless CMS Development",
    desc: "Modern API-driven content platforms delivering omnichannel experiences across web and mobile.",
    tags: ["Headless", "Sanity", "Contentful"],
  },
];
...
const industries = [
  {
    ...
    text: "text-blue-400",
    list: ["Payment Gateways", "Banking Portals", "Trading Platforms"],
  },
  {
    icon: HeartPulse,
    title: "Healthcare",
    ...
    list: ["Patient Portals", "Telemedicine Systems", "Hospital Management"],
  },
  {
    icon: ShoppingBag,
    ...
    list: ["Custom Storefronts", "Inventory Management", "Omnichannel Apps"],
  },
  {
    icon: Building2,
    title: "Real Estate",
    ...
    text: "text-cyan-400",
    list: ["Property Portals", "CRM Integration", "Facility Management"],
  },
  {
    icon: Truck,
    title: "Logistics",
    ...
    text: "text-amber-400",
    list: ["Fleet Tracking", "Warehouse Management", "Route Optimization"],
  },
  {
    icon: GraduationCap,
    title: "EdTech",
    ...
    list: ["E-Learning Portals", "Student LMS", "Virtual Classrooms"],
  },
  {
    icon: Factory,
    title: "Manufacturing",
    ...
    text: "text-slate-300",
    list: ["Production Monitoring", "Quality Control Apps", "ERP Platforms"],
  },
  {
    icon: PlaneTakeoff,
    title: "Travel",
    ...
    text: "text-sky-400",
    list: ["Booking Engines", "PMS Systems", "Itinerary Builders"],
  },
];
...
const techStack = [
  {
    ...
    text: "text-blue-400",
    tech: [".NET Core", "Node.js", "PHP / Laravel", "Python"],
  },
  {
    title: "FRONTEND",
    icon: Monitor,
    ...
    text: "text-cyan-400",
    tech: ["React / Next.js", "Angular", "Vue.js", "JavaScript"],
  },
  {
    title: "MOBILE APPS",
    icon: Smartphone,
    color: "from-purple-500 to-pink-500",
    text: "text-purple-400",
    tech: ["React Native", "Flutter", "iOS / Swift", "Android"],
  },
  {
    title: "CMS & E-COM",
    icon: FileCode2,
    color: "from-orange-500 to-rose-500",
    text: "text-orange-400",
    tech: ["Shopify Apps", "WordPress", "Optimizely", "Sanity"],
  },
  {
    title: "CRM & ERP",
    icon: Network,
    ...
    tech: ["Salesforce", "SAP B1", "ZOHO ERP", "HubSpot"],
  },
  {
    title: "CLOUD & AI",
    icon: CloudLightning,
    ...
    text: "text-emerald-400",
    tech: ["AWS / Azure", "Docker", "AI Chatbots", "LLM Agents"],
  },
];
...
const processSteps = [
  {
    ...
    desc: "Agile Digital Edge understands your technical requirements, project scope, and delivery timeline.",
  },
  {
    icon: UserPlus,
    step: "2",
    title: "Dedicated Team Setup",
    desc: "Experienced developers are carefully selected and assigned based on your project needs.",
  },
  {
    icon: PlayCircle,
    step: "3",
    title: "Agile Development",
    desc: "Agile Digital Edge's engineers work within your development processes, tools, and communication channels.",
  },
  {
    icon: PackageCheck,
    step: "4",
    title: "White Label Delivery",
    desc: "All code, documentation, and deliverables are provided entirely under your brand identity.",
  },
  {
    icon: HeadphonesIcon,
    step: "5",
    title: "Ongoing Support",
    desc: "Continuous improvements, maintenance releases, and feature development as you grow.",
  },
];
...
const engagementModels = [
  {
    ...
    desc: "Hire one or more developers working exclusively on your projects.",
    features: [
      "Full-time resource",
  ...
  },
  {
    ...
    desc: "Scale with a complete offshore engineering team — developers, QA, and lead.",
    features: [
  ...
  },
  {
    icon: Box,
    title: "Project-Based",
    desc: "End-to-end delivery for a clearly defined software project with fixed scope.",
    features: [
      "Fixed scope",
      "Milestone delivery",
      "Documentation",
...
const faqs = [
  {
    ...
    a: "White label software development is a partnership model where Agile Digital Edge builds the software and you sell it entirely under your agency's brand. Your clients interact only with you, and you maintain complete ownership of the client relationship.",
  },
  {
    q: "Why do digital agencies use offshore white label development partners?",
    a: "Agencies partner with Agile Digital Edge to scale development capacity instantly without the massive overhead of hiring local in-house talent. It allows them to access specialized enterprise developers, heavily increase profit margins, and deliver complex projects much faster.",
  },
  {
    q: "Can your developers collaborate directly with our internal team?",
    a: "Absolutely. Agile Digital Edge's developers seamlessly integrate into your existing workflows, natively using your internal communication tools (Slack, Teams, etc.), version control systems, and agile tracking processes.",
  },
  {
    q: "How do agencies maintain strict client confidentiality in white label partnerships?",
    a: "Agile Digital Edge operates under an ironclad Non-Disclosure Agreement (NDA). If desired, our developers will use your agency's email addresses (@yourdomain.com), appear as your direct employees in any required client meetings, and maintain absolute stealth.",
  },
];
      ...
      <div className="relative z-10">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-12 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-slate-400 leading-relaxed max-w-xl font-medium">
                The trusted offshore development partner for elite digital
                agencies. Agile Digital Edge builds complex{" "}
                <strong className="text-white">
                  CMS, CRM, Website, Mobile apps, Shopify apps and AI apps
                </strong>{" "}
                entirely under your brand. No overhead. Infinite scale.
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                <button
                  onClick={() =>
                    document
                      .getElementById("partnership-application")
                ...
                <button
                  onClick={() =>
                    document
                      .getElementById("engineering-arsenal")
                      ?.scrollIntoView({ behavior: "smooth" })
                  }
              ...
              <div className="flex flex-wrap items-center gap-3 pt-6 border-t border-white/10 mt-6">
                {["US • UK • UAE", "Enterprise CMS", "AI Solutions"].map(
                  (badge, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-1.5 text-xs font-semibold text-slate-300 bg-white/5 px-3 py-1.5 rounded-lg border border-white/5"
                    >
              ...
              <div className="relative w-full max-w-2xl aspect-square md:aspect-[4/3] flex items-center justify-center max-sm:scale-[0.85]">
                ...
                >
                  ...
                  <div className="flex justify-between items-center mb-8">
                    ...
                    <div className="flex gap-2">
                      <span className="px-2 py-1 rounded bg-white/10 text-[10px] font-bold text-white tracking-wider border border-white/5">
                        LIVE
                      </span>
                    ...
                    {[
                      {
                        ...
                        pct: "98%",
                        stroke: "from-blue-400 to-purple-500",
                      },
                      {
                        label: "Next.js / React Ecosystem",
                        pct: "95%",
                        stroke: "from-cyan-400 to-emerald-400",
                      },
                      {
                        label: "Wordpress / WooCommerce Ecosystem",
                        pct: "95%",
                        stroke: "from-cyan-400 to-emerald-400",
                      },
                      {
                        ...
                        pct: "95%",
                        stroke: "from-green-400 to-red-400",
                      },
                      {
                        label: "Enterprise CMS & CRM",
                        pct: "90%",
                        stroke: "from-orange-400 to-rose-400",
                      },
                      {
                        label: "Cloud & DevOps",
                        pct: "85%",
                        stroke: "from-fuchsia-400 to-violet-500",
                      },
                    ].map((item, i) => (
                      <div key={i} className="relative group/bar">
                        <div className="flex justify-between text-xs mb-1.5 font-bold uppercase tracking-wider">
                          <span className="text-slate-300 group-hover/bar:text-white transition-colors">
                            {item.label}
                          </span>
                          <span className="text-transparent bg-clip-text bg-gradient-to-r group-hover/bar:from-white group-hover/bar:to-white transition-colors">
                            {item.pct}
                          </span>
                        </div>
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-sm text-white font-black leading-none">
                      Wordpress
                    </div>
                  </div>
                </motion.div>
        ...
        <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10 overflow-hidden">
          ...
          <div className="relative z-10 text-center mb-24 max-w-3xl mx-auto">
            ...
            >
              Strategic alliances that empower growth and technical excellence.
              Agile Digital Edge provides the elite, silent engine behind your
              most ambitious client projects.
            </motion.p>
          </div>
            ...
            {partners.map((partner, i) => {
              const theme = [
                {
                  ...
                  text: "text-cyan-400",
                  borderHover:
                    "group-hover:border-white group-hover:shadow-[0_0_40px_rgba(255,255,255,0.15)]",
                  inner: "bg-cyan-500/10",
                },
                {
                  color: "fuchsia",
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute -right-20 -top-20 w-64 h-64 bg-gradient-to-br ${theme.glow} rounded-full blur-[80px] opacity-10 group-hover:opacity-30 transition-opacity duration-700 pointer-events-none`}
                  ></div>

                  {/* Horizontal animated tracking laser */}
                  <div
                    className={`absolute top-0 left-0 w-full h-[2px] bg-gradient-to-r from-transparent via-white to-transparent -translate-x-[100%] group-hover:translate-x-[100%] transition-transform duration-[1.5s] ease-in-out opacity-20`}
                  ></div>
                  ...
                  <div className="relative flex flex-col xl:flex-row gap-8 items-start mb-12 z-10">
                    <div className="relative isolate shrink-0">
                      {/* Exploding icon aura */}
                      <div
                        className={`absolute inset-0 bg-gradient-to-r ${theme.glow} blur-xl rounded-full scale-150 opacity-0 group-hover:opacity-60 transition-opacity duration-500`}
                      ></div>
                      <div className="w-20 h-20 bg-[#111] border border-white/10 rounded-3xl flex items-center justify-center relative z-10 group-hover:-rotate-12 transition-transform duration-500 shadow-2xl overflow-hidden">
                        <partner.icon
                          className={`w-10 h-10 ${theme.text} transition-colors duration-500 drop-shadow-lg scale-110`}
                        />
                      </div>
                    </div>
                  ...
                  <div className="relative flex items-center gap-4 text-slate-500 text-[10px] font-black tracking-widest uppercase group-hover:text-white transition-colors duration-500 z-10 mt-auto pt-6 border-t border-white/5">
                    <span
                      className={`px-4 py-2 rounded-xl bg-[#0a0a0a] border border-white/10 ${theme.text} group-hover:border-current ${theme.inner} transition-all duration-500 select-none`}
                    >
                      Alliance Tier One
                    </span>
        ...
        <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative overflow-hidden border-t border-white/5">
          <div className="text-center max-w-4xl mx-auto mb-20 relative z-10">
            ...
            >
              Expand technical capabilities without inflating operational costs.
              A reliable agile partner allows you to deliver sophisticated
              platforms while you focus purely on growth.
            </motion.p>
          </div>
                ...
                <ul className="space-y-6 relative z-10">
                  {reasonsList.map((reason, i) => (
                    ...
                    >
                      ...
                      <span className="text-slate-200 font-medium text-[15px] leading-relaxed">
                        {reason}
                      </span>
                    </motion.li>
                  ))}
            ...
            <div className="lg:col-span-7 grid sm:grid-cols-2 gap-6 lg:gap-8">
              {features.map((feature, i) => (
                ...
                >
                  {/* Card Neon Glow */}
                  <div
                    className={`absolute -inset-[2px] bg-gradient-to-br ${i % 2 === 0 ? "from-rose-500 to-orange-500" : "from-violet-500 to-fuchsia-500"} rounded-[2.2rem] opacity-0 group-hover:opacity-100 blur-md transition-opacity duration-500`}
                  ></div>
                  <div
                    className={`absolute -inset-[2px] bg-gradient-to-br ${i % 2 === 0 ? "from-rose-500 to-orange-500" : "from-violet-500 to-fuchsia-500"} rounded-[2.2rem] opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                  ></div>
                  ...
                  <div className="h-full bg-[#0a0a0a] backdrop-blur-xl border border-white/5 rounded-[2rem] p-8 md:p-10 relative overflow-hidden flex flex-col items-start z-10 shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${i % 2 === 0 ? "from-rose-500/10 to-transparent" : "from-fuchsia-500/10 to-transparent"} opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`}
                    ></div>

                    <div className="relative mb-8">
                      {/* Aura glowing spot */}
                      <div
                        className={`absolute inset-0 ${i % 2 === 0 ? "bg-orange-500/20" : "bg-fuchsia-500/20"} blur-2xl rounded-full scale-150 opacity-0 group-hover:opacity-100 transition-opacity duration-500`}
                      ></div>
                      ...
                      <div className="w-16 h-16 bg-[#171717] border border-white/10 rounded-2xl flex items-center justify-center relative z-10 shadow-xl group-hover:-rotate-6 group-hover:scale-110 transition-transform duration-500">
                        <feature.icon
                          className={`w-8 h-8 ${i % 2 === 0 ? "text-orange-400" : "text-fuchsia-400"}`}
                        />
                      </div>
                    </div>
                    ...
                    <div className="mt-8 w-12 h-1 bg-white/10 rounded-full overflow-hidden z-10">
                      <div
                        className={`h-full w-0 bg-gradient-to-r ${i % 2 === 0 ? "from-orange-400 to-rose-500" : "from-fuchsia-400 to-violet-500"} group-hover:w-full transition-all duration-700 ease-out`}
                      ></div>
                    </div>
                  </div>
                </motion.div>
        ...
        <section
          id="engineering-arsenal"
          className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10 overflow-hidden"
        >
          ...
          <div className="text-center max-w-3xl mx-auto mb-20 relative z-10">
            ...
            >
              Comprehensive software development expertise delivered flawlessly,
              silently, and entirely under your brand identity.
            </motion.p>
          </div>
            ...
            {services.map((service, i) => {
              const theme = [
                {
                  ...
                  to: "to-rose-500",
                  text: "text-orange-400",
                  bgLight: "group-hover:bg-orange-500/10",
                  borderLight: "group-hover:border-orange-500/50",
                ...
                },
                {
                  ...
                  to: "to-violet-500",
                  text: "text-fuchsia-400",
                  bgLight: "group-hover:bg-fuchsia-500/10",
                  borderLight: "group-hover:border-fuchsia-500/50",
                ...
                },
                {
                  ...
                  to: "to-orange-500",
                  text: "text-rose-400",
                  bgLight: "group-hover:bg-rose-500/10",
                  borderLight: "group-hover:border-rose-500/50",
                  glow: "from-rose-400 to-orange-500",
                },
                {
                  from: "from-violet-500",
                  to: "to-fuchsia-500",
                  text: "text-violet-400",
                  bgLight: "group-hover:bg-violet-500/10",
                  borderLight: "group-hover:border-violet-500/50",
                ...
                },
                {
                  ...
                  to: "to-orange-500",
                  text: "text-amber-400",
                  bgLight: "group-hover:bg-amber-500/10",
                  borderLight: "group-hover:border-amber-500/50",
                  glow: "from-amber-400 to-orange-500",
                },
                {
                  from: "from-pink-500",
                  to: "to-rose-500",
                  text: "text-pink-400",
                  bgLight: "group-hover:bg-pink-500/10",
                  borderLight: "group-hover:border-pink-500/50",
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`absolute -inset-3 bg-gradient-to-br ${theme.glow} rounded-[2.6rem] opacity-0 group-hover:opacity-20 blur-2xl transition-opacity duration-700 z-0`}
                  ></div>
                  ...
                  <div className="relative h-full bg-[#080808]/80 backdrop-blur-3xl border border-white/10 group-hover:border-white/40 rounded-[2.4rem] p-8 md:p-10 flex flex-col z-10 overflow-hidden shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)] group-hover:shadow-[0_0_20px_rgba(255,255,255,0.05),inset_0_1px_1px_rgba(255,255,255,0.3)] transition-all duration-500">
                    ...
                    <div
                      className={`absolute top-0 left-0 right-0 h-48 bg-gradient-to-b ${theme.from}/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}
                    ></div>

                    {/* Internal ambient corner glow */}
                    <div
                      className={`absolute -top-12 -right-12 w-48 h-48 bg-gradient-to-br ${theme.glow} rounded-full blur-[50px] opacity-10 group-hover:opacity-30 transition-opacity duration-700 pointer-events-none`}
                    ></div>
                    ...
                    <div className="relative mb-10 flex justify-between items-start z-10">
                      <div className="relative isolate">
                        {/* Exploding icon aura */}
                        <div
                          className={`absolute inset-0 bg-gradient-to-r ${theme.glow} blur-xl rounded-full scale-110 opacity-0 group-hover:opacity-40 transition-opacity duration-500`}
                        ></div>
                        ...
                        <div className="w-16 h-16 bg-[#111] border border-white/10 group-hover:border-white/30 rounded-2xl flex items-center justify-center relative z-10 group-hover:-rotate-3 group-hover:scale-105 transition-all duration-500 shadow-2xl bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]">
                          <service.icon
                            className={`w-8 h-8 ${theme.text} transition-colors duration-500 drop-shadow-lg`}
                          />
                        </div>
                      </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {industries.map((ind, i) => (
              ...
              >
                ...
                <div
                  className={`absolute top-0 right-0 w-32 h-32 bg-gradient-to-br ${ind.color} blur-[80px] opacity-0 group-hover:opacity-20 transition-opacity duration-700 pointer-events-none rounded-full`}
                ></div>

                <div className="relative mb-8 z-10 w-max isolation">
                  <div
                    className={`absolute inset-0 bg-gradient-to-r ${ind.color} blur-xl rounded-full opacity-0 group-hover:opacity-30 transition-opacity duration-500 -z-10`}
                  ></div>
                  <div
                    className={`w-14 h-14 bg-[#111] rounded-2xl flex items-center justify-center border border-white/10 group-hover:border-white/30 transition-colors shadow-xl bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a]`}
                  >
                    <ind.icon
                      className={`w-6 h-6 ${ind.text} transition-all duration-500 drop-shadow-lg group-hover:scale-110`}
                    />
                  </div>
                </div>
                ...
                <ul className="space-y-3 relative z-10">
                  {ind.list.map((item, j) => (
                    <li
                      key={j}
                      className="flex gap-3 items-center text-slate-400 font-medium text-sm group-hover:text-slate-300 transition-colors duration-300"
                    >
        ...
        <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10">
          <div className="text-center mb-20">
            <motion.span className="text-blue-400 font-bold tracking-widest text-sm uppercase mb-4 block">
              TECHNOLOGY STACK
            </motion.span>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {techStack.map((cat, i) => (
              ...
              >
                ...
                <div
                  className={`absolute -top-12 -right-12 w-48 h-48 bg-gradient-to-br ${cat.color} rounded-full blur-[60px] opacity-0 group-hover:opacity-20 transition-opacity duration-700 pointer-events-none`}
                ></div>

                {/* 1px Edge Light on Hover */}
                <div
                  className={`absolute bottom-0 left-8 right-8 h-[1px] bg-gradient-to-r from-transparent via-white/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 pointer-events-none`}
                ></div>

                <div className="flex items-center gap-5 mb-8 relative z-10 border-b border-white/5 pb-6">
                  <div
                    className={`w-14 h-14 bg-gradient-to-b from-[#1a1a1a] to-[#0a0a0a] rounded-2xl flex flex-col items-center justify-center border border-white/10 group-hover:border-white/30 shadow-xl transition-all duration-500`}
                  >
                    <cat.icon
                      className={`w-6 h-6 ${cat.text} group-hover:scale-110 drop-shadow-md transition-transform duration-500`}
                    />
                  </div>
                ...
                <div className="grid grid-cols-2 gap-3 relative z-10 flex-grow content-start">
                  {cat.tech.map((t, j) => (
                    ...
                    >
                      <div
                        className={`w-2 h-2 rounded-full bg-white/10 group-hover/tech:bg-current ${cat.text} transition-colors duration-300 shadow-sm group-hover/tech:shadow-[0_0_8px_currentColor]`}
                      ></div>
                      <span className="truncate group-hover/tech:text-white transition-colors">
                        {t}
                      </span>
                    </div>
                  ))}
        ...
        <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            <motion.span className="text-rose-400 font-bold tracking-widest text-sm uppercase mb-4 block">
              OUR PROCESS
            </motion.span>
            <motion.h2 className="text-4xl md:text-5xl lg:text-7xl font-black mb-6 tracking-tighter">
              How Agile Digital Edge's <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-rose-400 to-orange-400 drop-shadow-lg">
                Partnership Works
              </span>
            </motion.h2>
          </div>
          ...
          <div className="grid md:grid-cols-3 lg:grid-cols-5 gap-y-16 gap-x-6 relative mt-10">
            {processSteps.map((step, i) => {
              const stepThemes = [
                ...
                {
                  glow: "from-yellow-500 to-emerald-500",
                  wash: "from-yellow-500/10",
                },
              ];
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute -top-10 left-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-[#080808] border border-white/10 group-hover:border-white/40 flex items-center justify-center shadow-2xl transition-all duration-500 z-20">
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${theme.glow} rounded-full blur-xl opacity-20 group-hover:opacity-70 transition-opacity duration-500`}
                    ></div>
                    <div className="absolute inset-[1.5px] bg-[#111] rounded-full z-10 transition-colors duration-500 group-hover:bg-[#0a0a0a]"></div>
                    <span
                      className={`text-2xl font-black text-transparent bg-clip-text bg-gradient-to-br ${theme.glow} relative z-20 group-hover:scale-110 transition-transform duration-500`}
                    >
                      {step.step}
                    </span>
                  </div>
                  ...
                  <div
                    className={`absolute top-0 inset-x-0 h-32 bg-gradient-to-b ${theme.wash} to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-700 rounded-t-[2rem] pointer-events-none z-0`}
                  ></div>
        ...
        <section className="pb-32 pt-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10">
          <div className="text-center mb-20">
            <motion.span className="text-fuchsia-400 font-bold tracking-widest text-sm uppercase mb-4 block">
              ENGAGEMENT MODELS
            </motion.span>
            ...
            <p className="text-slate-400 text-lg md:text-xl font-medium">
              Choose the collaboration model that fits your agency's exact
              needs.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
            {engagementModels.map((model, i) => (
              <motion.div
                key={i}
                className={`relative bg-[#050505] rounded-[2.5rem] p-8 md:p-12 border transition-transform duration-500 flex flex-col h-full ${model.popular ? "border-fuchsia-500/60 shadow-[0_0_50px_rgba(217,70,239,0.15)] lg:-translate-y-4 hover:scale-[1.02]" : "border-white/10 hover:border-white/20 hover:-translate-y-2 lg:mt-4"} group isolate`}
              >
                {model.popular && (
                  <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-fuchsia-600 to-violet-600 text-white text-[10px] font-black tracking-widest uppercase px-6 py-2 rounded-full shadow-lg z-20">
                    Most Popular
                  </div>
                )}
                ...
                <div
                  className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-10 border shadow-xl transition-transform group-hover:scale-110 ${model.popular ? "bg-gradient-to-br from-fuchsia-500 to-violet-600 border-white/20 text-white" : "bg-[#111] border-white/10 text-slate-300 group-hover:text-white"}`}
                >
                ...
                <p className="text-slate-400 mb-8 border-b border-white/10 pb-8 font-medium leading-relaxed">
                  {model.desc}
                </p>
                ...
                <ul className="space-y-5 mb-10 relative z-10 flex-grow">
                  {model.features.map((feat, j) => (
                    ...
                    >
                      <div
                        className={`w-5 h-5 rounded flex justify-center items-center shrink-0 ${model.popular ? "bg-fuchsia-500/20 text-fuchsia-400" : "bg-white/5 text-slate-400"}`}
                      >
        ...
        <section className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-8 items-start">
            <div className="lg:col-span-5 relative z-10">
              <motion.span className="text-cyan-400 font-bold tracking-widest text-sm uppercase mb-4 block">
                FAQ
              </motion.span>
              ...
              <p className="text-slate-400 text-lg leading-relaxed mb-8">
                Everything you need to know about Agile Digital Edge's elite
                white label development partnership model, stealth practices,
            ...
            <div className="lg:col-span-7 space-y-4">
              {faqs.map((faq, i) => (
                <div
                  key={i}
                  className={`bg-[#050505] border rounded-2xl overflow-hidden transition-all duration-300 ${openFaq === i ? "border-cyan-500/50 shadow-[0_0_30px_rgba(34,211,238,0.15)]" : "border-white/5 hover:border-white/10"}`}
                >
                  <button
                    onClick={() => setOpenFaq(openFaq === i ? -1 : i)}
                    className="w-full text-left px-6 py-5 flex items-center justify-between font-bold text-lg text-white group"
                  >
                    <span className="group-hover:text-cyan-400 transition-colors pr-4">
                      {faq.q}
                    </span>
                    <ChevronDown
                      className={`w-5 h-5 text-slate-500 transition-transform duration-300 ${openFaq === i ? "rotate-180 text-cyan-400" : ""}`}
                    />
                  </button>
                  <AnimatePresence>
                    {openFaq === i && (
        ...
        <section
          ...
          className="py-24 lg:py-32 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto border-t border-white/5 relative z-10"
        >
          <div className="bg-[#050505] border border-white/5 rounded-[3rem] p-4 sm:p-8 lg:p-12 relative overflow-hidden shadow-[inset_0_2px_4px_rgba(255,255,255,0.05)]">
            ...
            <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 relative z-10">
              ...
              <div className="lg:col-span-5 flex flex-col justify-center max-lg:pt-8">
                <div className="inline-flex px-4 py-2 rounded-full border border-blue-500/30 bg-blue-500/10 text-blue-400 text-xs font-bold tracking-widest uppercase mb-6 shadow-[0_0_20px_rgba(59,130,246,0.2)] w-max">
                ...
                <p className="text-slate-400 text-lg mb-10 leading-relaxed">
                  Partner with experienced offshore developers to fundamentally
                  scale your agency's capabilities. Deliver monumental projects,
                  grow profit margins, and maintain complete brand ownership.
                </p>

                <ul className="space-y-4 mb-12">
                  {[
                    "Deliver high-end projects without hiring overhead",
                    "Exponentially increase agency profit margins",
                    "Access enterprise CMS & custom software experts",
                    "100% Dedicated offshore development teams",
                  ].map((item, i) => (
                    <li
                      key={i}
                      className="flex items-center gap-4 text-slate-300 font-medium select-none"
                    >
                ...
                <div className="space-y-4 mb-10">
                  ...
                  >
                    ...
                    <span className="font-bold">
                      hello@agiledigitaledge.com
                    </span>
                  </a>
                  <a
                    href="tel:+918810227237"
                    className="flex items-center gap-4 text-slate-400 hover:text-white transition-colors group"
                  >
                    ...
                    <span className="font-bold">+1 (561) 327-7682</span>
                  </a>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  <button className="flex-1 bg-white/5 border border-white/10 hover:border-blue-500/50 hover:bg-blue-500/10 font-bold text-white py-4 rounded-xl transition-all flex justify-center items-center gap-2">
                    <Calendar className="w-4 h-4 text-blue-400" /> Schedule a
                    Call
                  </button>
                  ...
                  >
                      ...
                      <div className="space-y-2 relative">
                        ...
                        <div className="relative mt-1">
                          ...
                          >
                            ...
                            <option value="1-2 Developers">
                              1-2 Developers
                            </option>
                            <option value="3-5 Developers">
                              3-5 Developers
                            </option>
                            <option value="6-10 Developers">
                              6-10 Developers
                            </option>
                            <option value="10+ Dedicated Team">
                              10+ Dedicated Team
                            </option>
                          </select>
                          <ChevronDown className="w-4 h-4 text-slate-500 absolute right-4 top-1/2 -translate-y-1/2 pointer-events-none" />
                      ...
                      <div className="flex flex-wrap gap-2 mt-1">
                        {[
                          ...
                          <div
                            ...
                            className={`px-4 py-2 rounded-xl border text-[10px] font-black cursor-pointer transition-all uppercase tracking-wider select-none ${
                    ...
                    <div className="pt-4 border-t border-white/10">
                      <button
                        ...
                        className={`w-full py-5 rounded-2xl font-black text-sm uppercase tracking-widest flex justify-center items-center gap-3 transition-all ${
                          status.loading
                            ? "bg-slate-800 text-slate-500 cursor-not-allowed"
                            : "bg-gradient-to-r from-blue-600 to-emerald-500 text-white hover:shadow-[0_0_30px_rgba(59,130,246,0.4)] hover:scale-[1.01]"
                        }`}
                      >
                        {status.loading ? "Sending..." : "Discuss Partnership"}{" "}
                    ...
                    <AnimatePresence>
                      {status.success && (
                        ...
                        >
                          Inquiry sent successfully! We will contact you
                          shortly.
                        </motion.div>
                      )}
                      {status.error && (
