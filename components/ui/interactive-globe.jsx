...
export function InteractiveGlobe({
    ...
    const rotYRef = useRef(1.0); // Show more of the northern hemisphere facing forward
    const rotXRef = useRef(0); // Set to 0 so the globe faces directly front instead of downwards
